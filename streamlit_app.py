...
if st.session_state.logged_in:
    ...
    def main():
        ...
        menu = ["AI", "DS", "ML", "DA Gray", "DA Black", "DA White", "DS6", "DS7 Blue", "DS7 Green", "DS8 Tracker",
                "App Development", "AI 03 Tracker", "DA Cohort 02 Orange", "DA Cohort 02 Yellow","DS Cohort 09 Electron","DS Cohort 09 proton","LRP Fellowship_attendence_Tracker","DA03 Tracker Azure","DA03 Tracker AWS"]
            ...
            if st.button("Update") and choice is not None:
                ...
                urls = {
                    ...
                    "DS Cohort 09 Electron": "DS%2009%20attendence%20tracker%20Electron.csv",
                     ...
                     "LRP Fellowship_attendence_Tracker": "LRP%20Fellowship_attendence_Tracker.csv",
                    "DA03 Tracker Azure": "DA%2003%20Attendence%20Tracker%20(Azure).csv",
                    "DA03 Tracker AWS" : "DA%2003%20Attendence%20Tracker%20(AWS).csv"
                }
